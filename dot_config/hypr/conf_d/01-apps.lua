...
volume_toggle = run_app .. " wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"
volume_decrease = run_app .. " wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"
volume_increase = run_app .. " wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+"
mic_toggle = run_app .. " wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"
