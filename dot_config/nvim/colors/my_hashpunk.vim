...
" Hashpunk
let s:MainColor = ['197', '#E0254C']
let s:ComplementaryColor = ['198', '#E2122E']

let s:Grey0 = ['16', '#595D65']
...
" My Hashpunk
let s:Green           =  ['20'  , '#76A15D']
let s:Pink            =  ['5'   , '#9B2551']
let s:Magenta         =  ['1'   , '#5D284F']
let s:TheGrey         =  ['233' , '#FFD6ED']
...
call s:highlight('CursorLineNr', s:Green, s:clear, s:none)
...
call s:highlight('NERDTreeOpenable', s:Green, s:clear, s:none)
...
call s:highlight('IndentBlanklineChar', s:Grey19, s:clear, s:none)
